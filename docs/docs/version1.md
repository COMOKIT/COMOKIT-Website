...
Relying on sub-models that have been extensively tested and validated, spatial and social data that can be collected easily and quickly, COMOKIT has been designed from the ground up to be generic, scalable and portable in a variety of social, epidemiological, economic, and geographical scenarios. As a consequence, it is highly configurable and extendable to new case studies. 
...
Issues regarding the model can be reported [here](https://github.com/COMOKIT/COMOKIT-Model/issues). Other enquiries might be directed to contact@comokit.org.  
