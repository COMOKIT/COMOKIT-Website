...
An [all-in-one distribution of **COMOKIT** V2.0](https://github.com/COMOKIT/COMOKIT-Model/releases/tag/v2.0) (comprising a Java Virtual Machine, GAMA 19 and **COMOKIT** itself), together with a [comprehensive set of guidelines and documentation](https://comokit.org/docs/), allows first-time users of GAMA to quickly experiment with the model and build their own extensions or applications in a matter of minutes. Advanced GAMA users can download and import the model from its [GitHub repository](https://github.com/COMOKIT/COMOKIT-Model). Additional datasets are available in a [separate repository](https://github.com/COMOKIT/COMOKIT-Datasets).
...
[Download COMOKIT V2.0](https://github.com/COMOKIT/COMOKIT-Model/releases/tag/v2.0){: .btn .text-center }
